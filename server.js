...
app.get('/api/:villainName', (request, response) => {
    const villainsName = request.params.villainName.toLowerCase()
    if(villains[villainsName]){
        response.json(villains[villainsName])
    }else{
